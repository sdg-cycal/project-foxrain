...
public:
	UPROPERTY(Config, EditAnywhere, Category = "Patrol Point")
	FColor PathPointsColor = FColor::Green;
	...
	UPROPERTY(Config, EditAnywhere, Category = "Patrol Point", meta = (ClampMin = 0.f, UIMin = 0.f))
