...
public:	
	...
	UFUNCTION(BlueprintImplementableEvent, Category = "UPSEnemyPointAction", meta = (DisplayName = "On Point Action Aborted By Character"))
	void K2_AbortEnemyPointAction(ACharacter* Character);
...
protected:	
	...
	UFUNCTION(BlueprintPure, Category = "UPSEnemyPointAction")
	virtual bool HasFreePointComponent();

	UFUNCTION(BlueprintCallable, Category = "UPSEnemyPointAction")
	virtual UUPSEnemyPointActionComponent* GetFreeEnemyActionPointComponent(ACharacter* Character);

	UFUNCTION(BlueprintPure, Category = "UPSEnemyPointAction")
	virtual UUPSEnemyPointActionComponent* GetCharacterPoint(ACharacter* Character);
