...
{
	K2_AbortEnemyPointAction(Character);
...
void AUPSEnemyPointAction::ClearPointActionForCharacter(ACharacter* Character)
{
	...
	ActionFinishedCallbacks[Character].ExecuteIfBound(this, Character);
...
UUPSEnemyPointActionComponent* AUPSEnemyPointAction::GetFreeEnemyActionPointComponent(ACharacter* Character)
{
...
UUPSEnemyPointActionComponent* AUPSEnemyPointAction::GetCharacterPoint(ACharacter* Character)
{
...
bool AUPSEnemyPointAction::CanStartPointAction(ACharacter* Character)
{
