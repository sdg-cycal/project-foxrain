...
AUPSPatrolPoint::AUPSPatrolPoint()
{
	...
	NextPatrolPointSolver = CreateDefaultSubobject<UUPSPatrolPointSolver_RandomPoint>(TEXT("NextPatrolPointSolver"));
...
AUPSPatrolPoint* AUPSPatrolPoint::GetNextPatrolPoint(ACharacter* Character)
{
	...
	{
		if (NextPatrolPointSolver != nullptr)
		{
			...
			return NextPatrolPointSolver->SelectPatrolPoint(patrolPointLinks, this, Character);
		}
	}
